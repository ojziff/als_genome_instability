...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, dev="Cairo_png", dpi=72, fig.height = 8, fig.width = 10)
library(here)
...
# 
# saveRDS(ipsc_mn_sporadic_datasets$res, here(proj_path,"expression/deseq2/ipsc_mn_sporadic_datasets.res.rds"))
# saveRDS(ipsc_mn_fus_datasets$res, here(proj_path,"expression/deseq2/ipsc_mn_fus_datasets.res.rds"))
# saveRDS(ipsc_mn_sod1_datasets$res, here(proj_path,"expression/deseq2/ipsc_mn_sod1_datasets.res.rds"))
# saveRDS(ipsc_mn_c9orf72_datasets$res, here(proj_path,"expression/deseq2/ipsc_mn_c9orf72_datasets.res.rds"))
# saveRDS(ipsc_mn_tardbp_datasets$res, here(proj_path,"expression/deseq2/ipsc_mn_tardbp_datasets.res.rds"))
