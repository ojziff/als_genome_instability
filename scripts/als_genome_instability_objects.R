...
# sbatch -N 1 -c 12 --mem=0 -t 72:00:00 --wrap="Rscript /camp/lab/patanir/home/users/ziffo/projects/ipsc-mn-als-meta/scripts/ipsc_mn_als_meta/ipsc_mn_als_meta_objects.R" --mail-type=ALL,ARRAY_TASKS --mail-user=oliver.ziff@crick.ac.uk --job-name=DESeq2objects
# sbatch -N 1 -c 12 --mem=72G -t 72:00:00 --wrap="Rscript /camp/lab/patanir/home/users/ziffo/projects/ipsc-mn-als-meta/scripts/ipsc_mn_als_meta/ipsc_mn_als_meta_objects.R" --mail-type=ALL,ARRAY_TASKS --mail-user=oliver.ziff@crick.ac.uk --job-name=DESeq2objects --dependency=afterany:44191817,44191802
# sbatch -N 1 -c 6 --mem=50G -t 8:00:00 --wrap="Rscript /camp/lab/patanir/home/users/ziffo/projects/ipsc-mn-als-meta/scripts/ipsc_mn_als_meta/ipsc_mn_als_meta_objects.R" --mail-type=ALL,ARRAY_TASKS --mail-user=oliver.ziff@crick.ac.uk --job-name=DESeq2objects 
# sbatch --cpus-per-task=10 --mem=1500G -N 1 --partition=hmem -t 72:00:00 --wrap="Rscript /camp/lab/patanir/home/users/ziffo/projects/ipsc-mn-als-meta/scripts/ipsc_mn_als_meta/ipsc_mn_als_meta_objects.R" --mail-type=ALL,ARRAY_TASKS --mail-user=oliver.ziff@crick.ac.uk --job-name=DESeq2objects
...
# counts_all = read_tsv("/camp/lab/patanir/home/users/ziffo/projects/ipsc-mn-als-meta/nfcore/star_salmon/salmon.merged.gene_counts.tsv")
