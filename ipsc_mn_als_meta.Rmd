...
burden_test = function(n1=NULL, n2=NULL, ss1=NULL, ss2=NULL, pval=T, cov_threshold=0.5, alternative="greater"){
  if(!any(!is.null(n1) & !is.null(n2) & !is.null(ss1) & !is.null(ss2))){    stop("Must supply n1, n2, ss1 and ss2")  }
  if(n1 > ss1) n1 = ss1
  if(n2 > ss2) n2 = ss2
  if(n1==0) n1=0.5
  if(n2==0) n2=0.5
...
# remotes::install_github("adamwaring/ClusterBurden")
...
# base_substitutions.als_ctrl.sd.type <- plot_spectrum.type(type_occurrences, by = answerals.metadata$condition, CT = FALSE, indv_points = TRUE, error_bars = "stdev") # error bars SD rather than 95% CI
# base_substitutions.als_ctrl.sd.type
