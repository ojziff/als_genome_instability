...
celltype.markers.rnaseq.heatmap <- Heatmap(celltype.markers.marker.mat, 
          ...
          bottom_annotation = columnAnnotation(markers = anno_block(gp = gpar(fill = rep("white",14)), labels = c("Catanese", "Lee", "Dafianca", "Luisier", "Mitchell","Wang","Moccia","Sareen","Sterneckert","Kapeli","Melamed","DeSantis","Smith","Signapore"), labels_gp = gpar(fontsize = 6), labels_rot = 0)), column_split = c(rep(1,12),rep(2,9),rep(3,22),rep(4,6),rep(5,6),rep(6,4),rep(7,5),rep(8,8),rep(9,6),rep(10,6),rep(11,4),rep(12,6),rep(13,5),rep(14,4)))
