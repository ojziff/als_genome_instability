...
mouse_als_datasets = readRDS(here(proj_path,"expression/deseq2/mouse_als_datasets.rds"))
mouse_c9orf72_datasets = readRDS(here(proj_path,"expression/deseq2/mouse_c9orf72_datasets.rds"))
mouse_fus_datasets = readRDS(here(proj_path,"expression/deseq2/mouse_fus_datasets.rds"))
mouse_sod1_datasets = readRDS(here(proj_path,"expression/deseq2/mouse_sod1_datasets.rds"))
mouse_tardbp_datasets = readRDS(here(proj_path,"expression/deseq2/mouse_tardbp_datasets.rds"))
...
```{r}
# import SRR_Acc_List.txt
SRR_Acc_List_barham.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_barham.txt"), col_names = FALSE)
SRR_Acc_List_fernandez.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_fernandez.txt"), col_names = FALSE)
SRR_Acc_List_herskovits.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_herskovits.txt"), col_names = FALSE)
SRR_Acc_List_lopez.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_lopez.txt"), col_names = FALSE)
SRR_Acc_List_marsala.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_marsala.txt"), col_names = FALSE)
SRR_Acc_List_orourke.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_orourke.txt"), col_names = FALSE)
SRR_Acc_List_rezvykh.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_rezvykh.txt"), col_names = FALSE)
SRR_Acc_List_rudnick.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_rudnick.txt"), col_names = FALSE)
SRR_Acc_List_shan.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_shan.txt"), col_names = FALSE)
SRR_Acc_List_phatnani.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_phatnani.txt"), col_names = FALSE)
SRR_Acc_List_henriques.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_henriques.txt"), col_names = FALSE)
SRR_Acc_List_white.txt = read_tsv(here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_white.txt"), col_names = FALSE)
SRR_Acc_List_mouse_meta.txt = bind_rows(SRR_Acc_List_barham.txt, SRR_Acc_List_fernandez.txt, SRR_Acc_List_herskovits.txt, SRR_Acc_List_lopez.txt, SRR_Acc_List_marsala.txt, SRR_Acc_List_orourke.txt, SRR_Acc_List_rezvykh.txt, SRR_Acc_List_rudnick.txt, SRR_Acc_List_shan.txt, SRR_Acc_List_phatnani.txt, SRR_Acc_List_henriques.txt, SRR_Acc_List_white.txt)
SRR_Acc_List_mouse_meta.txt
write_tsv(SRR_Acc_List_mouse_meta.txt, here(proj_path, "mouse-meta/sample-details/SRR_Acc_List_mouse_meta.txt"), col_names = FALSE)


# import SraRunTable.txt
SraRunTable_barham.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_barham.txt"), col_types = list(Age="c")) %>% clean_names %>% 
  mutate(dataset = "barham", strandedness = "reverse", mutation = case_when(grepl("WT",source_name) ~ "ctrl", grepl("G118V", source_name) ~ "pfn1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_fernandez.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_fernandez.txt")) %>% clean_names %>% 
  mutate(dataset = "fernandez", strandedness = "reverse", mutation = case_when(grepl("wild",genotype) ~ "ctrl", grepl("g93a",genotype) ~ "sod1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_herskovits.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_herskovits.txt")) %>% clean_names %>% 
  mutate(dataset = "herskovits", strandedness = "unstranded", mutation = case_when(grepl("Wild",genotype) ~ "ctrl", grepl("G93a",genotype) ~ "sod1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_lopez.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_lopez.txt")) %>% clean_names %>% 
  mutate(dataset = "lopez", strandedness = "reverse", mutation = case_when(grepl("WT",genotype_variation) ~ "ctrl", grepl("R521H|R521C",genotype_variation) ~ "fus")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_marsala.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_marsala.txt")) %>% clean_names %>% 
  mutate(dataset = "marsala", strandedness = "reverse", mutation = case_when(grepl("Wild",genotype) ~ "ctrl", grepl("SOD1",genotype) ~ "sod1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_orourke.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_orourke.txt")) %>% clean_names %>% 
  mutate(dataset = "orourke", strandedness = "unstranded", mutation = case_when(grepl("F08",genotype) ~ "ctrl", grepl("F112exp",genotype) ~ "c9orf72")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_rezvykh.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_rezvykh.txt")) %>% clean_names %>% 
  mutate(dataset = "rezvykh", strandedness = "unstranded", mutation = case_when(grepl("Non-transgenic",source_name) ~ "ctrl", grepl("Transgenic",source_name) ~ "fus")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_rudnick.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_rudnick.txt")) %>% clean_names %>% 
  mutate(dataset = "rudnick", strandedness = "unstranded", mutation = case_when(grepl("SOD1G93A",genotype) ~ "sod1", TRUE ~ "ctrl")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_shan.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_shan.txt")) %>% clean_names %>% 
  mutate(dataset = "shan", strandedness = "unstranded", mutation = case_when(grepl("nontransgenic",genotype_variation) ~ "ctrl", TRUE ~ "tardbp")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_phatnani.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_phatnani.txt")) %>% clean_names %>% 
  mutate(dataset = "phatnani", strandedness = "unstranded", mutation = case_when(grepl("WT",genotype_variation) ~ "ctrl", grepl("SOD1",genotype_variation) ~ "sod1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_henriques.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_henriques.txt")) %>% clean_names %>% 
  mutate(dataset = "henriques", strandedness = "reverse", mutation = case_when(grepl("wild",genotype) ~ "ctrl", grepl("SOD1",genotype) ~ "sod1")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_white.txt = read_csv(here(proj_path, "mouse-meta/sample-details/SraRunTable_white.txt")) %>% clean_names %>% 
  mutate(dataset = "white", strandedness = "reverse", mutation = case_when(grepl("+",genotype_variation) ~ "ctrl", grepl("Q331K",genotype) ~ "tardbp")) %>%
  group_split(mutation) %>% purrr::map_df(~.x %>% group_by(sample_name) %>% mutate(replicate = cur_group_id())) %>% ungroup %>% # assign each unique experiment_accession ID a replicate ID
  mutate(sample = paste(mutation,replicate,sep="_")) %>% select(sample, strandedness, mutation, replicate, dataset, everything())
SraRunTable_mouse_meta.txt = bind_rows(SraRunTable_barham.txt, SraRunTable_fernandez.txt, SraRunTable_herskovits.txt, SraRunTable_lopez.txt, SraRunTable_marsala.txt, SraRunTable_orourke.txt, SraRunTable_rezvykh.txt, SraRunTable_rudnick.txt, SraRunTable_shan.txt, SraRunTable_phatnani.txt, SraRunTable_henriques.txt, SraRunTable_white.txt)
SraRunTable_mouse_meta.txt %>% glimpse
write_tsv(SraRunTable_mouse_meta.txt, here(proj_path, "mouse-meta/sample-details/SraRunTable_mouse_meta.txt"))

samplesheet = SraRunTable_mouse_meta.txt %>% 
  mutate(fastq_1 = case_when(library_layout == "SINGLE" ~ paste0("/camp/lab/luscomben/home/users/ziffo/projects/ipsc-mn-als-meta/mouse-meta/reads/fastq/",experiment,"_",run,".fastq.gz"), library_layout == "PAIRED" ~ paste0("/camp/lab/luscomben/home/users/ziffo/projects/ipsc-mn-als-meta/mouse-meta/reads/fastq/",experiment,"_",run,"_1.fastq.gz")),
         fastq_2 = case_when(library_layout == "SINGLE" ~ "",  library_layout == "PAIRED" ~ paste0("/camp/lab/luscomben/home/users/ziffo/projects/ipsc-mn-als-meta/mouse-meta/reads/fastq/",experiment,"_",run,"_2.fastq.gz")),
         mutation_replicate = sample, sample = paste0(dataset,"_",sample), condition = case_when(mutation == "ctrl" ~ "ctrl", TRUE ~ "als")) %>% select(sample, fastq_1, fastq_2, strandedness, condition, mutation, replicate, dataset, mutation_replicate, everything())
samplesheet
samplesheet %>% glimpse
write_csv(samplesheet, here(proj_path, "mouse-meta/sample-details/samplesheet.csv"), na = "")

samplesheet %>% distinct(dataset)
samplesheet %>% distinct(dataset, mutation) %>% print(n=Inf)
samplesheet %>% distinct(dataset, strandedness) %>% print(n=Inf)
```
...
# Colour by dataset
ipsc_mn_als_datasets_with_lee.pca_dataset <- ggplot(ipsc_mn_als_datasets_with_lee.pcaData, aes(PC1, PC2, color = library_type)) + geom_point(aes(color=dataset), size=1) + 
  ...
  theme_oz() + theme(legend.text=element_text(size=8), legend.title=element_text(size=10), legend.position = "right", legend.spacing = unit(0.01, 'cm')) +
...
ipsc_mn_als_datasets_with_lee.pca_merged = plot_grid(
  # ipsc_mn_als_datasets_with_lee.pca_dataset, 
  ipsc_mn_als_datasets_with_lee.pca_library_type, ipsc_mn_als_datasets_with_lee.pca_instrument, 
  ipsc_mn_als_datasets_with_lee.pca_gender, ipsc_mn_als_datasets_with_lee.pca_DIV, 
  ipsc_mn_als_datasets_with_lee.pca_als, ipsc_mn_als_datasets_with_lee.pca_mutation,
  nrow = 3, ncol = 2, labels = "auto")
# ipsc_mn_als_datasets_with_lee.pca_merged
ggsave(ipsc_mn_als_datasets_with_lee.pca_merged, filename = here(proj_path,"expression/deseq2/ipsc_mn_als_datasets_with_lee.pca_merged.png"), height = 10, width = 8)
```
...
ipsc_mn_als_progeny.pathwayActivity <- ggplot(ipsc_mn_als_progeny.contrast_acts, aes(x=reorder(source, score), y = score)) +
    ...
    stat_pvalue_manual(ipsc_mn_als_progeny.contrast_acts, label = "p.signif", y.position = 14, xmin = "source", xmax = NULL, size = 5, hide.ns = TRUE) 
...
ipsc_mn_als.noiso_progeny.contrast_acts <- run_wmean(mat=ipsc_mn_als_datasets.noiso.res.matrix, net=net_progeny, .source='source', .target='target', .mor='weight', times = 100, minsize = 5) %>% filter(statistic == 'norm_wmean') %>% mutate(p.signif = case_when(p_value < 0.003 ~ "****", p_value < 0.009 ~ "***",p_value < 0.01 ~ "**",p_value < 0.05 ~ "*", TRUE ~ ""), group1 = source, group2 = source)
ipsc_mn_als.noiso_progeny.pathwayActivity <- ggplot(ipsc_mn_als.noiso_progeny.contrast_acts, aes(x=reorder(source, score), y = score)) +
    ...
    theme_oz() + theme(axis.text.x = element_text(angle = 90), legend.position = "none", plot.title = element_text(hjust = 0.5)) +
    labs(title = "Signaling Pathways", x = "", y = "ALS vs CTRL Normalised enrichment") +
    stat_pvalue_manual(ipsc_mn_als_progeny.contrast_acts, label = "p.signif", y.position = 12, xmin = "source", xmax = NULL, size = 6, hide.ns = TRUE) 
...
genetic_subgroups_scatter_upset = plot_grid(
  ...
  plot_de_correlation(model_list1 = ipsc_mn_mutations_list, model_list2 = ipsc_mn_mutations_list, mutation1 = "FUS", mutation2 = "TARDBP", highlight = c("TARDBP","FUS")), ipsc_mn_mutants_bind_datasets.res.upset, ncol = 3, rel_widths = c(1,1,2), labels = c("","","b")), nrow = 3)
# genetic_subgroups_compared.merged
ggsave(genetic_subgroups_scatter_upset, filename = here(proj_path,"expression/deseq2/genetic_subgroups_scatter_upset.png"), height = 8.25, width = 8.25)
...
als_ctrl.voila.gost = als_ctrl.voila %>% filter(changing_dpsi0.1 == TRUE) %>% group_split(deltapsi > 0) %>% map("gene_id") %>% gost()
...
als_ctrl.voila.gost_filt.terms$term_name = gsub("positive regulation of ", "", als_ctrl.voila.gost_filt.terms$term_name)
...
ipsc_mn_als_datasets.polyA$irfinder %>% filter(padj < 0.05) # 29
ipsc_mn_als_datasets.polyA$irfinder %>% filter(padj < 0.05) %>% distinct(gene_name)  # 15
ipsc_mn_als_datasets.polyA$irfinder %>% filter(padj < 0.05) %>% group_split(log2FoldChange < 0) # 22 up, 7 down
18/24 # 75%
...
ipsc_mn_als_datasets.polyA$irfinder %>% filter(padj < 0.05) %>% filter(gene_name %in% p53.DDR.repair_gene_set) %>% arrange(-stat) # 0
...
## Volcano
ipsc_mn_als_datasets.polyA$irfinder %>% filter(abs(stat) > 5, padj < 0.05) %>% arrange(-abs(stat)) %>% distinct(gene_name, .keep_all = TRUE) %>% pull(gene_name) # "ADAM32" "OTOF"   "DBX1"   "GSTM1"  "LCN9"   "KRT5"   "CDH19"  "P2RX2" 
ipsc_mn_als_datasets.polyA$irfinder %>% filter(log2FoldChange > 1, padj < 0.05, -log10(pvalue) >4, -log10(pvalue) <6) %>% arrange(-abs(stat)) %>% distinct(gene_name, .keep_all = TRUE) %>% pull(gene_name) #"SNED1"   "SVIL"    "MPP2"    "FAM118A" "NKAPD1" 
ipsc_mn_als_datasets.polyA$irfinder %>% filter(log2FoldChange > 1, padj < 0.05, -log10(pvalue) >5.5, -log10(pvalue) <6.5) %>% arrange(-abs(stat)) %>% distinct(gene_name, .keep_all = TRUE) %>% pull(gene_name)#"HBB"    "UGT2A1" "SNED1"  "SVIL"   "MPP2"  
"ADAM32" "OTOF"   "DBX1"   "GSTM1"  "LCN9"   "KRT5"   "CDH19"  "P2RX2" 
...
ipsc_mn_als_datasets.polyA.ir.volcano <- volcano_plot(ipsc_mn_als_datasets.polyA$irfinder, numerator = "ALS", denomenator = "CTRL",
               title = "Intron retention: pan ALS", subtitle = "polyA: 43 Controls vs 48 ALS", ymax = 7, xmax = 3, dpi = 300, gene_labels = c("SPHKAP", "SNED1","DBX1", "GSTM1","UGT2A1", "CYP4F29P","ADAM32", "OTOF"), distinct_labels = TRUE, arrow_labels = FALSE) +
...
## GO
ipsc_mn_als_datasets.polyA.gost <- ipsc_mn_als_datasets.polyA$irfinder %>% filter(padj < 0.05) %>% arrange(-abs(stat)) %>% distinct(gene_id, .keep_all = TRUE) %>% #group_split(log2FoldChange > 0) %>%
  pull("gene_id") %>% gost()
...
ipsc_mn_als_datasets.polyA.gost_filt_ir_up <- ipsc_mn_als_datasets.polyA.gost_filt %>% filter(query == "ALS IR down")  %>% filter(term_name %in% up_list)
...
ipsc_mn_als_datasets.polyA.ir.go_curated <- curated_profiles(ipsc_mn_als_datasets.polyA.gost_filt_ir, cols = c("firebrick2", "dodgerblue2")) + labs(title = "IR enrichment") + theme(plot.title=element_text(size=8), strip.text.y.right = element_blank()) #+ theme_oz()
...
# 1: p53.signalling 0.00341949 0.00341949 0.4317077 0.3941382 1.177981 1719
...
# Fig S15 TDP43 knockdown POLDIP event
